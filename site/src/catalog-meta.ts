export const CATALOG_GENERATED_AT = '2026-04-20';
...
export const ZED_CORE_VERSION = 'git-1db292d';
export const PULSAR_VERSION = 'git-2e263ac';
export const ZED_VERSION = 'git-1db292d';
